package com.sww.edu.common.advice;
...
import com.sww.edu.common.annotation.ConsumeVerified;
...
public class ConsumeVerifiedAdvice {
    ...
    @Pointcut("@annotation(com.sww.edu.common.annotation.ConsumeVerified)")
