package com.sww.edu.message.service.impl;
...
import com.sww.edu.message.mapper.MessageMapper;
...
public class MessageServiceImpl extends ServiceImpl<MessageMapper, Message> implements IMessageService {
	...
	*/
	@Override
	public void sendMessage(com.sww.edu.message.api.dto.Message message) {
		if(null == message) {
			return;
		}
