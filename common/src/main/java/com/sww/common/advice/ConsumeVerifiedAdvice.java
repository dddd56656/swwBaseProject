package com.sww.common.advice;
import java.lang.reflect.Method;

import com.sww.common.annotation.ConsumeVerified;
...
public class ConsumeVerifiedAdvice {
    ...
    @Pointcut("@annotation(common.annotation.ConsumeVerified)")
