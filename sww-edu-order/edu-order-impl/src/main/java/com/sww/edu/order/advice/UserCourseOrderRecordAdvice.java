package com.sww.edu.order.advice;
...
import com.sww.edu.order.annotation.UserCourseOrderRecord;
import com.sww.edu.order.api.enums.UserCourseOrderStatus;
import com.sww.edu.order.entity.UserCourseOrder;
import com.sww.edu.order.service.IUserCourseOrderRecordService;
...
public class UserCourseOrderRecordAdvice {
    ...
    @Pointcut("@annotation(com.sww.edu.order.annotation.UserCourseOrderRecord)")
     ...
     */
    com.sww.edu.order.entity.UserCourseOrderRecord buildUserCourseOrderRecord(String orderNo,Integer fromStatus,Integer toStatus){
    	com.sww.edu.order.entity.UserCourseOrderRecord saveUserCourseOrderRecord = new com.sww.edu.order.entity.UserCourseOrderRecord();
