...
import com.sww.edu.pay.api.enums.OperationType;
...
public class PayOrderRecordAdvice {
    ...
    @Pointcut("@annotation(com.sww.edu.pay.annotation.PayOrderRecord)")
     ...
     */
    com.sww.edu.pay.entity.PayOrderRecord buildPayOrderRecord(String orderNo,BigDecimal amount,Integer fromStatus,Integer toStatus,OperationType type) {
    	com.sww.edu.pay.entity.PayOrderRecord savePayOrderRecord = new com.sww.edu.pay.entity.PayOrderRecord();
		savePayOrderRecord.setCreatedAt(new Date());
    	savePayOrderRecord = new com.sww.edu.pay.entity.PayOrderRecord();
		savePayOrderRecord.setCreatedAt(new Date());
