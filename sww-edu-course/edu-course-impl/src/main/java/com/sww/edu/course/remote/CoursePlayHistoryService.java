...
import com.sww.edu.course.service.ICoursePlayHistoryService;
...
public class CoursePlayHistoryService  {
    ...
    public List<Integer> hasStudyLessons(Integer swwUserId, Integer courseId) {
        QueryWrapper queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("user_id",swwUserId);
